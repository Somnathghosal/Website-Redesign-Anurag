...
const researchData: ResearchItem[] = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/es1_hhhPLFg?si=KYzIcX8pfxiQcMxd", // Example video URL
  },
  {
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/dy18F8FOuCg?si=NCvTr7PW6QyCs8u4", // Example video URL
  },
];
...
const Research = () => {
  ...
  return (
    <div className="flex flex-col bg-gray-100 min-h-screen">
      ...
      <div className="flex bg-gray-100 mt-20 min-h-screen ">
        ...
        <div className="lg:w-1/2 lg:ml-auto p-4 lg:p-10 bg-gray-100 lg:overflow-y-auto">
          {/* Note on top */}
        ...
        {/* Popup Modal (remains the same as in the previous implementation) */}
        <AnimatePresence>
          {selectedResearch && (
            <motion.div
              ...
              >
                ...
                {selectedResearch.videoUrl ? (
                  ...
                  <div className="flex flex-col md:flex-row h-full max-h-[80vh]">
                    ...
                    <div className="p-6 md:w-1/2 overflow-y-auto max-h-[80vh] md:max-h-full">
                    ...
                    {/* Video Section */}
                    <div className="bg-gray-100 p-6 md:w-1/2 flex flex-col justify-center max-h-[80vh] md:max-h-full">
      ...
      {/* Enhanced Popup with Fixed Height and Scrollable Content */}
      <AnimatePresence>
        {selectedResearch && (
          <motion.div
            className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4 z-50"
